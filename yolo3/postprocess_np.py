...
def yolo3_postprocess_np(yolo_outputs, image_shape, anchors, num_classes, model_image_size, max_boxes=20, confidence=0.25, iou_threshold=0.15):
...
def yolo3_handle_predictions(predictions, max_boxes=20, confidence=0.25, iou_threshold=0.15):
    boxes = predictions[:, :, :4]
